            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        <img src="{{ asset('images/logo.svg') }}" alt="SA↔BD Portal" class="h-9 w-9">
                        <span class="hidden sm:block font-bold text-indigo-700 text-sm tracking-wide">SA↔BD Portal</span>
                    </a>
                </div>
